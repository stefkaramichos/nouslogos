...
@section('title', 'Νέο Στοιχείο Τιμοκαταλόγου')

@section('content')
<div class="card">
    <div class="card-header">
        <strong>Νέο Στοιχείο Τιμοκαταλόγου</strong>
    </div>

    <div class="card-body">
        <form action="{{ route('price_items.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="number" name="price" step="0.01" min="0" class="form-control" value="{{ old('price', '0.00') }}" required>
            </div>
